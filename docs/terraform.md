...
| <a name="input_requester_pays_enabled"></a> [requester\_pays\_enabled](#input\_requester\_pays\_enabled) | Boolean whether to enable Requester Pays option on the Athena workgroup. | `bool` | `false` | no |
